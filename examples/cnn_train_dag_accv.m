function [net,stats] = cnn_train_dag_accv(net, getBatch, varargin)
...
imdb = imdb_train_oneFixed_proposed();
imdb = attach_proposals_onefixed(imdb);
imdbt = imdb_test_nonrepetitive_train();
imdbt = attach_proposals_onefixed(imdbt);

imdb2 = imdb_train_2012();
imdb2 = attach_proposals_onefixed(imdb2);
imdb2t = imdb_test_nonrepetitive_train_2012();
imdb2t = attach_proposals_onefixed(imdb2t);
imdb = combine_2007_2012(imdb, imdbt, imdb2, imdb2t);

% imdb_train = imdb_INSTRE_train();
% % imdb_test = imdb_INSTRE_test();
% % imdb = combine(imdb_train, imdb_test);
% imdb = attach_proposals_onefixed(imdb_train);
% %%
