    ...
    methods
        function outputs = forward(obj, inputs,params)
            ...
            for b=1:size(pred_boxes,1)
                ...
                if pred_boxes(b,3) > Imagesize(b,3), pred_boxes(b,3) = Imagesize(b,3); end
                if pred_boxes(b,4) > Imagesize(b,4), pred_boxes(b,4) = Imagesize(b,4); end
                %for b=1:size(pred_boxes,1)
