...
VOCopts.imgsetpath = esc(fullfile(opts.dataDir, 'VOCdevkit', 'VOC2007', 'ImageSets', 'Main', '/%s.txt'));
VOCopts.annopath  = esc(fullfile(opts.dataDir, 'VOCdevkit', 'VOC2007' ,'Annotations', '/%s.xml'));

imdb.classes.name = VOCopts.classes ;
imdb.classes.description = VOCopts.classes ;
imdb.imageDir = esc(fullfile(opts.dataDir, 'VOCdevkit', 'VOC2007' ,'JPEGImages')) ;
