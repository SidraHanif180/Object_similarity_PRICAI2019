data_dir= 'C:\G_drive_data\Pascal_BBox3\Test';
T_1 = fullfile(data_dir, 'saliency_mat_test_1');
T_2 = fullfile(data_dir, 'saliency_mat_test_2');
T_3 = fullfile(data_dir, 'saliency_mat_test_3');
